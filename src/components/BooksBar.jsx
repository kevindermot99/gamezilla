...
function BooksBar() {
    return (
        <div className="bookbar w-[100%] h-fit flex overflow-x-scroll overscroll-contain pb-3 mb-6">
            {Books.map((book) => (
                <div className=' group flex flex-col w-fit h-auto rounded-xl transition duration-100 hover:bg-stone-200 dark:hover:bg-dark-sidebar p-3'>
                    ...
                    <h1 className=' break-words  whitespace-normal leading-5 my-1 text-base font-normal text-black dark:text-white '>{book.title}</h1>
