...
function SideBar() {
    ...
    return (
        <div className={` sticky top-0 transition-width duration-300 ${sidebar === "big" && 'w-[240px]'}  ${sidebar === "small" && 'w-[80px]'}  relative h-[100vh] flex flex-col items-start justify-start px-3 py-5 bg-gray-50  dark:bg-gray-950 dark:bg-opacity-10`}>
