...
function SideBar() {
    ...
    return (
        <div className={` sticky top-0 ${sidebar === "big" && 'w-[260px]'}  ${sidebar === "small" && 'w-[100px]'} duration-200  relative h-[100vh] flex flex-col items-start justify-start pl-3 pr-1 py-5 bg-stone-50  dark:bg-dark-sidebar dark:bg-opacity-95 backdrop-blur-2xl  `}>
