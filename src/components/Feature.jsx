        ...
        <div className={`flex gap-14 px-3 py-10 justify-center items-start w-full max-w-[1200px] ${direction != 'left' && ' flex-row-reverse '} my-16`}>
            <div className='flex flex-col gap-5 items-start justify-start w-[50%] max-w-[600px]'>
                ...
                <h1 className='text-black opacity-90 font-bold text-[35px] leading-[45px]'>
                    Lorem ipsum dolor sit amet ere saepe
                </h1>
                <p className='text-gray-600 font-medium text-xl leading-relaxed '>Lorem ipsum,  Praesentium ipsam quidem animi deserunt? Quas, in. oris odit pariatur sunt! Inventore iusto, expedita eos aut minima ipsum! Minus quia totam tempora blanditiis vel.</p>
                {
                    types == '1' &&
                
                    <div className='flex flex-col w-full gap-2'>
                        {formats.map((item, index) => (
                            <h1 key={index} className='py-5 px-6 text-black font-bold text-base flex gap-3 items-center justify-start bg-gray-100 bg-opacity-50 rounded-2xl '>
