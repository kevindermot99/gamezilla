    ...
    <div className=' h-svh overflow-y-auto flex flex-col text-text-color'>
      ...
      {bannerGame &&
        <div className='relative w-full h-fit min-h-[600px] overflow-clip '>
          ...
          <div className='relative z-10 w-full h-full flex flex-col items-start justify-end p-12'>
            ...
            <div className='flex gap-1 items-start justify-start mb-4'>
      ...
      <div className='p-12 max-w-[1400px] mx-auto'>
        ...
        <div className='grid grid-cols-7 my-8 gap-2'>
          {Games.map((game, index) => (
            <Link key={index} to={`/`} className='group' onClick={() => handleBanner(game.id)}>
              <div className='p-[2px] ring-2 ring-transparent group-hover:ring-main-color rounded-lg'>
                <img src={game.poster} className='pointer-events-none  bg-container-color aspect-square min-h-full object-cover object-top rounded-lg opacity-85 group-hover:opacity-65  ' />
              </div>
