  ...
  return (
    <div className=' h-svh overflow-y-auto flex flex-col text-text-color'>
      ...
      <div className='relative w-full h-fit min-h-[630px] '>
        <img src={'https://image.api.playstation.com/cdn/UP0006/CUSA00110_00/0ihyT1thfpkaypwhvFZhV1frZtmz13KA.jpg'} className='absolute top-0 left-0 -z-10 w-full h-full object-cover object-top    ' />
        <div className='absolute top-0 w-full h-full left-0 bg-gradient-to-t from-body-color to-body-color/30 '></div>
        <div className='relative z-10 w-full h-full flex flex-col items-start justify-end gap-3 px-12 py-3 '>
          ...
          <div className='absolute right-12 mb-20 w-[30%] max-w-[350px] bg-transparent max-lg:hidden overflow-clip '>
            ...
            <div className='w-full h-full overflow-x-auto flex items-center justify-start gap-2 py-3'>
              <img src={'https://media.moddb.com/cache/images/members/1/422/421372/thumb_620x2000/bf4_2013-11-24_12-16-14-09.jpg'} className='h-32 w-fit object-cover rounded-2xl border-4 border-stone-200/10 ' alt="" />
              <img src={'https://www.ps3blog.net/wp-content/uploads/Alley.jpg'} className='h-32 w-fit object-cover rounded-2xl border-4 border-stone-200/10 ' alt="" />
              <img src={'https://www.newgamenetwork.com/images/uploads/gallery/BF4/Battlefield4PC24.jpg'} className='h-32 w-fit object-cover rounded-2xl border-4 border-stone-200/10 ' alt="" />
              <img src={'https://www.newgamenetwork.com/images/uploads/gallery/Battlefield3/bf3%202011-11-05%2016-39-32-61.jpg'} className='h-32 w-fit object-cover rounded-2xl border-4 border-stone-200/10 ' alt="" />
              <img src={'https://www.newgamenetwork.com/images/uploads/gallery/Battlefield3/battlefield3_19.jpg'} className='h-32 w-fit object-cover rounded-2xl border-4 border-stone-200/10 ' alt="" />
            </div>
          </div>
