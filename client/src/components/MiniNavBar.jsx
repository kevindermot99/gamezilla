...
function MiniNavBar() {
  ...
  return (
    <div className="w-full h-fit bg-white dark:bg-body-color ">
      <div className="h-fit w-full max-w-[1300px] px-7 pb-5 pt-3 mx-auto flex items-center justify-between gap-3 ">
        ...
        {/* <form className=" w-1/4">
          <input
            type="search"
            name="search"
            className="h-[45px] w-full bg-stone-100 dark:bg-container-color  text-black dark:text-white placeholder:text-text-color-light  px-4 font-medium text-sm rounded-md  "
            autoComplete="off"
