...
function SquareImage({src, opacity}) {
  ...
  return (
    <div className={`relative flex w-[160px] h-[160px] min-w-[160px] min-h-[160px] aspect-square rounded-xl overflow-clip opacity-${opacity} transition-all duration-300 hover:opacity-100 cursor-pointer`}>
        {loading && <div className='w-full h-full absolute bg-body-color border-2 border-body-color flex justify-center items-center rounded-xl '><CgSpinner className='animate-spinLoader text-text-color-light/90 text-[40px] border-2 border-body-color' /></div> }
